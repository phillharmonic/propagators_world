...
class CommentFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $comment->setBlog($manager->merge($this->getReference('blog-6')));
        ...
        $comment->setBlog($manager->merge($this->getReference('blog-7')));
        $manager->persist($comment);
        ...
        $comment->setBlog($manager->merge($this->getReference('blog-8')));
        ...
        $comment->setBlog($manager->merge($this->getReference('blog-9')));
        ...
        $comment->setBlog($manager->merge($this->getReference('blog-10')));
        $manager->persist($comment);
