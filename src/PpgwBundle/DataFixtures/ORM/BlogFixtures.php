...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference('blog-6', $blog1);
        $this->addReference('blog-7', $blog2);
        $this->addReference('blog-8', $blog3);
        $this->addReference('blog-9', $blog4);
        $this->addReference('blog-10', $blog5);
    }
